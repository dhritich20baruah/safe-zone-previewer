      ...
      <main className="min-h-screen flex flex-col items-center p-6 md:p-12 bg-slate-900">
        ...
        <section className="max-w-4xl w-full mt-14 grid grid-cols-1 sm:grid-cols-2 gap-6">
          {[
            ...
            },
            {
              ...
              href: "/instagram-reels-safe-zone",
              body: (
                <>
                  Instagram blocks the right side with reaction icons and the bottom with profile
                  info. Preview the{" "}
                  <strong className="text-slate-200">IG Reel safe zone</strong> before you post
            ...
            },
            {
              ...
              body: (
                <>
                  YouTube Shorts overlays a like/dislike bar, subscribe button, and audio
                  attribution across your frame. Use this{" "}
                  <strong className="text-slate-200">YouTube Shorts safe zone</strong> checker
                  to keep your title text and branding fully visible.
                </>
              ),
            },
            {
            ...
            <article
              key={title}
              className="bg-slate-800 rounded-xl border border-slate-700 shadow-sm p-5 hover:border-blue-500 transition-colors"
            >
              <Link href={href}>
                <h2 className="text-lg font-bold text-white hover:text-blue-400 transition-colors mb-2">
                  {title} →
                </h2>
              </Link>
        ...
        <section className="max-w-4xl w-full mt-14 space-y-4">
          ...
          <p className="text-slate-400">
            ...
            same 9:16 layout but with a slightly smaller bottom margin — approximately 380 pixels —
            and a lighter icon treatment on the right side. What counts as safe for TikTok is not
            always safe for an <strong className="text-slate-200">IG Reel safe zone</strong>, which
            is why checking both separately matters if you cross-post content.
          </p>
          <p className="text-slate-400">
            The <strong className="text-slate-200">YouTube Shorts safe zone</strong> has one of
            the most complex overlay layouts — a right-side action bar with like, dislike, comment,
            share, and remix buttons, plus a bottom bar with the channel name, subscribe button,
            and audio attribution. The{" "}
            <strong className="text-slate-200">YouTube Thumbnail safe zone</strong> is different
            again — it uses a 16:9 landscape canvas and the main hazard is the auto-generated
          ...
          <p className="text-slate-400">
            ...
            repurposing landscape videos into vertical clips for TikTok or Instagram Reels. In
